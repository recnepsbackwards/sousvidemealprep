...
if ( ! function_exists( 'ot_register_settings_page' ) ) {
  ...
  function ot_register_settings_page() {
    global $ot_has_trident_theme_options;
    
    // Display UI Builder admin notice
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_trident_theme_options == true || has_action( 'admin_init', 'trident_theme_options' ) ) ) {
      
      function ot_has_trident_theme_options() {
      ...
      add_action( 'admin_notices', 'ot_has_trident_theme_options' );
...
function trident_theme_options() {
  ...
  global \$ot_has_trident_theme_options;
  \$ot_has_trident_theme_options = true;
