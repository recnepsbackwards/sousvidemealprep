						...
						<?php } if( !empty( $linkedin ) ) { ?>
							<div class="footer-social-block">
								<a href="<?php echo esc_url( $linkedin ); ?>" class="linkedin">
									<i class="icofont fa fa-pinterest"></i>
									<div class="footer-social-content">
										<?php esc_html_e('Pinterest','editorialmag'); ?>
										<span class="social-sub-title"><?php esc_html_e('Join us on Pinterest','editorialmag'); ?></span>
									</div>
								</a>
							</div>
						<?php } ?>
...
<?php wp_footer(); ?>
<div id="amzn-assoc-ad-509822e6-d30d-4bf3-b33d-8fbb1dd7e133"></div><script async src="//z-na.amazon-adsystem.com/widgets/onejs?MarketPlace=US&adInstanceId=509822e6-d30d-4bf3-b33d-8fbb1dd7e133"></script>
</body>
</html>
