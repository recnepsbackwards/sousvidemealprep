...
class Cooked_Recipes {
	            ...
	            foreach( $recipes as $key => $recipe ):
	                ...
	                echo '<div class="cooked-srl-single' . $has_image_class . '" style="width:100%; max-width:' . $width . '">';
						...
						echo '<div class="cooked-srl-content">';
							...
							echo '<div class="cooked-srl-title"><a href="' . esc_url( get_permalink($rid) ) . '">' . $recipe['title'] . '</a></div>';
	...
	public static function card( $rid, $width = false, $hide_image = false, $hide_title = false, $hide_excerpt = false, $hide_author = false, $style = false ){
		...
		echo '<a href="' . esc_url( get_permalink($rid) ) . '" class="cooked-recipe-card' . $style_class . '" style="width:100%; max-width:' . $width . '">';
			...
			echo '<span class="cooked-recipe-card-content">';
				...
				echo ( !$hide_title ? '<span class="cooked-recipe-card-title">' . $recipe['title'] . '</span>' : '' );
				...
				echo ( !$hide_excerpt ? '<span class="cooked-recipe-card-excerpt">' . $recipe['excerpt'] . '</span>' : '' );
	...
	public function recipe_template( $content ){
		...
		if ( is_singular('cp_recipe') && is_main_query() && $_cooked_content_unfiltered == false && in_the_loop () ):
			...
			return apply_filters( 'cooked_recipe_content_filter', $content );
