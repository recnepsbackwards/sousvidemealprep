...
class Cooked_Recipe_Meta {
    ...
    public function save_recipe_meta_box( $post_id ) {
        ...
        $seo_content = apply_filters( 'cooked_seo_recipe_content', '<h2>' . $recipe_excerpt . '</h2><h3>' . __('Ingredients','cooked') . '</h3>[cooked-ingredients checkboxes=false]<h3>' . __('Directions','cooked') . '</h3>[cooked-directions numbers=false]' );
