...
class Cooked_Admin_Menus {
	...
	public function add_menu() {
		...
		add_submenu_page('cooked_recipes_menu', esc_html__('Settings','cooked'), esc_html__('Settings','cooked'), 'administrator', 'cooked_settings', array(&$this, 'cooked_settings_page') );
