...
.cooked-recipe-card-modern-centered:hover .cooked-recipe-card-sep { background:<?php echo $_cooked_settings['main_color']; ?>; }
.cooked-timer-obj,
...
.cooked-browse-search-button:hover { background:<?php echo $_cooked_settings['main_color_hover']; ?>; }<?php
